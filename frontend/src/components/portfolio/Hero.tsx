...
export function Hero() {
    ...
    return (
        <header className="min-h-screen flex items-center pt-14 relative overflow-hidden" id="top">
            ...
            {/* ridgelines — hidden on mobile for cleaner look */}
            <svg className="hidden md:block absolute bottom-0 left-0 right-0 w-full" viewBox="0 0 1440 360" preserveAspectRatio="none">
            ...
            <div className="max-w-6xl mx-auto px-6 w-full relative z-10">
                ...
                {/* ── MOBILE LAYOUT ── */}
                <div className="flex flex-col md:hidden min-h-[calc(100vh-3.5rem)] justify-center py-12 gap-8">

                    {/* status pill */}
                    <div className="flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full bg-[#5bbf8a] animate-pulse" />
                        <span className="text-[#5bbf8a]/70 text-xs font-mono">
                            available for senior & staff-level roles
                        </span>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-white/40 font-mono text-sm leading-relaxed">
                            Software Engineer · Go + React · Pacific Northwest
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {STATS.map(s => (
                            <div key={s.value}
                                 className="bg-[#161b22] border border-white/[0.06] rounded-xl p-3 text-center">
                                <div className="text-2xl font-bold text-[#5bbf8a] leading-none mb-1">
                                    {s.value}
                                </div>
                                <div className="text-white/30 font-mono text-[10px] leading-tight">
                                    {s.label}
                                </div>
                            </div>
                        ))}
                    ...
                    <p className="text-white/50 text-sm font-mono leading-relaxed">
                        Nine years sharpening systems as an SDET —
                        now shipping <span className="text-white">full-stack products</span>{' '}
                        with <span className="text-[#5bbf8a]">Go and React</span>.
                    </p>

                    {/* CTAs */}
                    <div className="flex gap-3">
                        <a href="#projects"
                           className="flex-1 py-3 rounded-lg bg-[#5bbf8a] text-[#0d1117]
                                      font-semibold text-sm text-center
                                      hover:bg-[#5bbf8a]/90 transition-colors font-mono">
                            view work ↗
                        </a>
                        <a href="#contact"
                           className="flex-1 py-3 rounded-lg border border-white/10
                                      text-white/70 text-sm text-center font-mono
                ...
                <div className="hidden md:grid grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-6">
                            <span className="w-2 h-2 rounded-full bg-[#5bbf8a] animate-pulse" />
                            <span className="text-[#5bbf8a]/70 text-sm font-mono">
                                available for senior & staff-level roles
                            </span>
                        </div>
                        ...
                        <p className="text-white/50 text-lg leading-relaxed mb-8">
                            ...
                            in the Pacific Northwest. Nine years sharpening systems as an SDET — now shipping{' '}
                            <span className="text-[#5bbf8a]">full-stack products</span>{' '}
                            with Go and React.
                        </p>
                        <div className="flex gap-3">
                            <a href="#projects"
                               className="px-6 py-3 rounded-lg bg-[#5bbf8a] text-[#0d1117]
                                          font-semibold text-sm hover:bg-[#5bbf8a]/90 transition-colors">
                                view work ↗
                            </a>
                            <a href="#contact"
                               className="px-6 py-3 rounded-lg border border-white/10
                                          text-white/70 text-sm hover:border-white/20
